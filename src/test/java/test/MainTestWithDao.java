...
public class MainTestWithDao {
	...
	public static void main(String[] args) throws ParseException {
		...
		Application.getInstance().getLoginDao().create(log1);
		
		log1.setAdmin(true);
		
		//MAJ de log1
		Application.getInstance().getLoginDao().update(log1);
